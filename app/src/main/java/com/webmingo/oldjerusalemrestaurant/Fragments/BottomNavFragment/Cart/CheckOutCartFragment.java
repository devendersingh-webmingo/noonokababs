...
import com.webmingo.oldjerusalemrestaurant.Adapters.cart.CheckOut.ItemOnCheckOutAdapter;
...
import com.webmingo.oldjerusalemrestaurant.SharedPrefernce.CheckAmount;
import com.webmingo.oldjerusalemrestaurant.SharedPrefernce.SharedPrefManager;
import com.webmingo.oldjerusalemrestaurant.ViewPresenter.Cart.FoodCartPresenter;
import com.webmingo.oldjerusalemrestaurant.databinding.FragmentCheckOutCartBinding;
...
public class CheckOutCartFragment extends Fragment implements FoodCartPresenter.FoodCartView, ItemOnCheckOutAdapter.ItemCartclick {
   ...
   binding.AddFavTV.setOnClickListener(new View.OnClickListener() {
        ...
        if (viewCartRequest1 != null) {
            ...
            binding.NotOrderFoundCV.setVisibility(View.VISIBLE);
        }
    ...
    public void onFoodCartSuccess(FoodCartViewRepo response, String message) {
       ...
       // Log.e("tax_percent", response.getData().getTaxPercent());
        if (message.equalsIgnoreCase("ok")) {
            ...
            binding.PayoutdetailLL.setVisibility(View.VISIBLE);
            binding.NotOrderFoundCV.setVisibility(View.GONE);
