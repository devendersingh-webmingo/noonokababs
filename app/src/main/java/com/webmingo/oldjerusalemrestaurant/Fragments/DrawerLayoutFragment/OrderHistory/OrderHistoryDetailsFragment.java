...
import com.webmingo.oldjerusalemrestaurant.Adapters.OrderHistoryAdapter.OrderDetailsAdapter;
...
import com.webmingo.oldjerusalemrestaurant.databinding.FragmentOrderHistoryDetailsBinding;
    ...
    public void onOrderHistoryDetailsSuccess(HistoryDetailsRepo response, String message) {
      /*  Snacky.builder()
        ...
        if (message.equalsIgnoreCase("ok")) {
            ...
            binding.DeliveryTypeTv.setText("Delivery Type :\n" + response.getData().getOrderDetail().getDeliveryType());

            binding.Deliverydatetv.setText(response.getData().getOrderDetail().getDelivery_datetime());
            ...
            if (response.getData().getOrderDetail().getTipPercent() != null) {
                ...
                binding.tipPercentRL.setVisibility(View.GONE);
                binding.tipAmountRL.setVisibility(View.GONE);
                binding.GratuityRL.setVisibility(View.VISIBLE);
                binding.Gratuitytv.setText("$"+response.getData().getOrderDetail().getTipAmount());

            }

            if (response.getData().getOrderDetail().getGetBranchInfo() != null) {
                binding.RestaurantLL.setVisibility(View.VISIBLE);
                binding.RestaurantnameTv.setText(response.getData().getOrderDetail().getGetBranchInfo().getName());

                binding.RestaurantContacttv.setText(response.getData().getOrderDetail().getGetBranchInfo().getMobileNumber());
            ...
            if (response.getData().getOrderDetail().getPaymentStatus().equalsIgnoreCase("Success")) {
                binding.ViewInvoicesLL.setVisibility(View.VISIBLE);

                binding.ViewInvoicesLL.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {


                        Bundle bundle = new Bundle();
                        bundle.putString("id", String.valueOf(response.getData().getOrderDetail().getOrderId()));

                        navController.navigate(R.id.invoiceWebFragment, bundle);
