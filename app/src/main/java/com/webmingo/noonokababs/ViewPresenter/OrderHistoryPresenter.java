...
public class OrderHistoryPresenter {
    ...
    public void Cancelorder(Context context, String order_id,String reason) {
        Call<ResponseBody> loginCall = ApiManager.getApi(context).Cancelorder(order_id,reason);
        view.showHideProgress(true);
