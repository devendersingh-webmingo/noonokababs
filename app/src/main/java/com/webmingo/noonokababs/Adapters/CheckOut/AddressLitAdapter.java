package com.webmingo.noonokababs.Adapters.CheckOut;
...
public class AddressLitAdapter extends RecyclerView.Adapter<AddressLitAdapter.myViewHolder> {
    ...
    public AddressLitAdapter(GetUserAddressRepo modelArrayList, Context context, AddressAdapterClick itemClickListenerr) {
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AddressLitAdapter.myViewHolder(view);
    }
